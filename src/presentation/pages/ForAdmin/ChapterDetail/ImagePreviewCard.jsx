...
export default function ImagePreviewCard({ img, index, onRemove, onDrop }) {
  ...
  return (
    <div
      ...
      className="relative group rounded-lg overflow-hidden border-2 border-gray-700 hover:border-blue-500 transition-all cursor-move shadow-lg"
    >
      <img
      ...
      <div className="absolute top-2 left-2 bg-black/80 px-3 py-1 rounded text-sm font-bold text-blue-400">
        {index + 1}
      </div>
      ...
      {img.isNew && (
        <div className="absolute bottom-2 right-2 bg-green-600 text-xs px-3 py-1.5 rounded font-bold">
          MỚI
        </div>
      )}
    </div>
